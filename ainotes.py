...
async def process_audio(audio: UploadFile = File(...)):
   try:
        ...
        with sr.AudioFile(wav_buffer) as source:
            ...
            transcribed_text = "This is a test recording. We are ignoring voice and dates for now. We just want a summary generated by OpenAi."
            print(f"DEBUG 2 - User input: {transcribed_text}")
